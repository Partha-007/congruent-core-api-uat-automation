...
#line hidden
                ...
                table157.AddRow(new string[] {
                            ...
                            "General Purpose"});
#line 8
await testRunner.WhenAsync("Configuration has been made as per following", ((string)(null)), table157, "When ");
#line hidden
#line 39
...
await testRunner.GivenAsync("Payroll file \"CombinedFile.csv\" is selected and Edit payroll file as mentioned be" +
                        "low", ((string)(null)), table158, "Given ");
#line hidden
#line 50
