...
Scenario: To verify  Refinancing - Multiple scenario - Refinancing by changing the amount when Model portfolio investment is added and verify the account balance
