...
| ZipCode      |
| 12345-987689 |
|              | Scenario: Validating the Zipcode field with null
| 12345-6      | Scenario: Validating the Zipcode field with length 6 characters
|         1234 | Scenario: Validating the Zipcode field with length 4 characters
