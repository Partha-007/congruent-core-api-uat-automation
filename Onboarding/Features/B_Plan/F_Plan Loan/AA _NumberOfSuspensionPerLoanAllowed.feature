Feature: AA _NumberOfSuspensionPerLoanAllowed
[BeforeTestRun]

Scenario:   To Verify the numberOfSuspensionsPerLoanAllowed as accept as 
 Given Model is selected for the endpoint "/api/Loan/SaveLoan"
  When Configuration has been made as per following
           | key                               | value         |
           | numberOfSuspensionsPerLoanAllowed | <Suspensions> |
